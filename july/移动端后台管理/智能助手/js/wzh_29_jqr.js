...
$("#saveButton_bstb").click(function () {
    alert(1)
    var btnTypeInput_bstb = $("#btnTypeInput_bstb").val();
    var btnStyleCartoonInput_bstb = $("#btnStyleCartoonInput_bstb").val();
    var btnStyleInput_bstb = $("#btnStyleInput_bstb").val();
    var btnTitleInput_bstb = $("#btnTitleInput_bstb").val();
    var diy_color = $("#diy-color").val();
    var btnPositionInput_bstb = $("#btnPositionInput_bstb").val();
    var sideDistanceInput_bstb = $("#sideDistanceInput_bstb").val();
    var belowDistanceInput_bstb = $("#belowDistanceInput_bstb").val();
    var s = {
    ...
    $.post("http://192.168.1.59:8083/userCenter/sapSecretKey/getDataByUserId",
        {
            dataId: 1,
            pUserId: 4,
...
//按钮样式变化
    $('.txtButton_bstb li').click(function () {
        ...
        $(this).addClass('checked');
        $('#btnStyleInput_bstb').val($(this).attr("data-value"));
...
//按钮位置变化
    ...
    $('.btnColor_bstb li').click(function () {
        ...
        $(this).addClass('checked');
        var end = $(this).attr("data-value").toUpperCase();
