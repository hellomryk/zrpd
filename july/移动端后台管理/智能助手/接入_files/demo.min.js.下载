...
$("#ribbon").append('<div class="demo"><span id="demo-setting"><i class="fa fa-cog txt-color-blueDark"></i></span> <form><legend class="no-padding margin-bottom-10">布局设置</legend><section><label><input name="subscription" id="smart-fixed-header" type="checkbox" class="checkbox style-0"><span>固定头部</span></label><label><input type="checkbox" name="terms" id="smart-fixed-navigation" class="checkbox style-0"><span>固定导航</span></label><label><input type="checkbox" name="terms" id="smart-fixed-ribbon" class="checkbox style-0"><span>固定菜单</span></label><label><input type="checkbox" name="terms" id="smart-fixed-footer" class="checkbox style-0"><span>固定底部</span></label><label><input type="checkbox" name="terms" id="smart-fixed-container" class="checkbox style-0"><span>切换窄版(无响应模式)</span></label><label style="display:block;"><input type="checkbox" id="smart-topmenu" class="checkbox style-0"><span>导航悬浮顶部</span></label> <span id="smart-bgimages"></span></section><section><h6 class="margin-top-10 semi-bold margin-bottom-5">清空本地缓存</h6><a href="javascript:void(0);" class="btn btn-xs btn-block btn-primary" id="reset-smart-widget"><i class="fa fa-refresh"></i> 重置系统</a></section> <h6 class="margin-top-10 semi-bold margin-bottom-5">皮肤选择</h6><section id="smart-styles"><a href="javascript:void(0);" id="smart-style-0" data-skinlogo="resources/bootstrap/img/logo.png" class="btn btn-block btn-xs txt-color-white margin-right-5" style="background-color:#4E463F;">夜空灰色</a><a href="javascript:void(0);" id="smart-style-1" data-skinlogo="resources/bootstrap/img/logo-white.png" class="btn btn-block btn-xs txt-color-white" style="background:#3A4558;">黑色优雅</a><a href="javascript:void(0);" id="smart-style-3" data-skinlogo="resources/bootstrap/img/logo-pale.png" class="btn btn-xs btn-block txt-color-white margin-top-5" style="background:#f78c40">清新淡雅</a><a href="javascript:void(0);" id="smart-style-2" data-skinlogo="resources/bootstrap/img/logo-blue.png" class="btn btn-xs btn-block txt-color-darken margin-top-5" style="background:#fff;"><i class="fa fa-check fa-fw" id="skin-checked"></i>默认皮肤</a></section></form> </div>');
var smartbgimage = "<h6 class='margin-top-10 semi-bold'>Background</h6><img src='resources/bootstrap/img/pattern/graphy-xs.png' data-htmlbg-url='resources/bootstrap/img/pattern/graphy.png' width='22' height='22' class='margin-right-5 bordered cursor-pointer'><img src='resources/bootstrap/img/pattern/tileable_wood_texture-xs.png' width='22' height='22' data-htmlbg-url='resources/bootstrap/img/pattern/tileable_wood_texture.png' class='margin-right-5 bordered cursor-pointer'><img src='resources/bootstrap/img/pattern/sneaker_mesh_fabric-xs.png' width='22' height='22' data-htmlbg-url='resources/bootstrap/img/pattern/sneaker_mesh_fabric.png' class='margin-right-5 bordered cursor-pointer'><img src='resources/bootstrap/img/pattern/nistri-xs.png' data-htmlbg-url='resources/bootstrap/img/pattern/nistri.png' width='22' height='22' class='margin-right-5 bordered cursor-pointer'><img src='resources/bootstrap/img/pattern/paper-xs.png' data-htmlbg-url='resources/bootstrap/img/pattern/paper.png' width='22' height='22' class='bordered cursor-pointer'>";
    ...
    $("#smart-styles > a").on("click",
        function() {
            ...
            $.root_.removeClassPrefix("smart-style").addClass(a.attr("id")),
                b.attr("src", $('#vsiteContextPath').val()+'/'+a.data("skinlogo")),
