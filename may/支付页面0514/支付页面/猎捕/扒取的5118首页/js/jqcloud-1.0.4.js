(function ($) {
    ...
    $.fn.jQCloud = function (word_array, options) {
        ...
        var drawWordCloud = function () {
            ...
            var step = 100, //(options.shape === "rectangular") ? 18.0 : 2.0,
            ...
            var drawOneWord = function (index, word) {
                ...
                var word_id = cloud_namespace + "_word_" + index,
					...
					angle = index * 10, //6.28 * Math.random(),
					radius = 0.0,
                ...
                if (word.link) {
                    ...
                    inner_html = $('<a target="_bank">').attr(word.link).text(word.text);
                } else {
                    inner_html = word.text;
                }
                word_span.append('<em class="point"></em>').append(inner_html);
